     	...
     	<div class="container">
        	<div class="row">
            	<!-- start of page content -->
              	...
              	<s:iterator  value ="strayPetList" status ="status">
	   	 			 <div class="span3">
			  			 <img src="images/cat01.jpg"  height="192.844" width="270" />
						 <h3>品种：<s:property value="kind" ></s:property></h3>
						 <h4>姓名：<s:property value="name"></s:property></h4>
					...
					<div id="pagination">
						<a href="stray_pet?kind=${kind }&pageNo=${pageNo-1}" class="btn">上一页</a>
                      	<a href="stray_pet?kind=${kind }&pageNo=1" class="btn active">1</a>
                        <a href="stray_pet?kind=${kind }&pageNo=2" class="btn">2</a>
                        <a href="stray_pet?kind=${kind }&pageNo=3" class="btn">3</a>
                        <a href="stray_pet?kind=${kind }&pageNo=${pageNo+1}" class="btn">下一页 »</a>
                   </div>
                   </div>
			</div>
