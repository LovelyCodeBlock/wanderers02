...
<div class="login" style="margin-top:50px;">
    ...
    <div class="web_qr_login" id="web_qr_login" style="display: block; height: 235px;">    
			...
			<div class="login_form">
				<form action="User_login" name="loginform" accept-charset="utf-8" id="login_form" class="loginForm" method="post">
  ...
  <!--注册-->
    ...
    <div class="web_login">
    <form name="form2" id="regUser" accept-charset="utf-8"  action="User_register" method="post">
        ...
        <ul class="reg_form" id="reg-ul">
                ...
                </li><div class="cl"><font color="red">${registerError}</font>	<!-- 显示错误 --></div>	<!-- 非格式错误 -->
